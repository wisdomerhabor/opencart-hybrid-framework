...
public class ExcelUtils {
	...
	// ** Define construstor and pass common variables to it in one instance e.g filepath
	public ExcelUtils(String filepath) {
		
		this.filepath = filepath; // this.x with accept the filepath passed and use it as the contructor's filepath
	}
		...
		try {
			...
			if (row != null) {
				...
				if (cell != null) {
					...
					data = formatter.formatCellValue(cell); // Read/get cell data as string
				}
			}
		} catch (Exception e) {
	...
	// 4. Update cell data
	public String setCellData(String sheetname, int rowNum, int cellNum, String data)
			throws IOException {
		// open file in read mode > fi
		fi = new FileInputStream(filepath);
